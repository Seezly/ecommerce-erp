...
<div
	{{ $attributes->class(['h-100 mb-4 flex flex-col items-center justify-between overflow-hidden rounded-lg shadow-lg']) }}>
	<div class="h-5/12 relative mb-4 w-full overflow-hidden">
		@if ($item['discount'] > 0)
			<span
				class="absolute left-2 top-2 rounded-full bg-gray-300 px-2 py-1 text-sm font-extralight">{{ $item['discount'] }}%</span>
		@endif
	...
	<div class="my-2 w-full border-b"></div>
	<div class="h-2/12 flex w-full items-center justify-between gap-8 px-6">
		...
		<div class="flex items-center justify-end gap-2">
			<a href="#" class="rounded-lg bg-gray-600 p-2"><svg xmlns="http://www.w3.org/2000/svg" class="size-4"
