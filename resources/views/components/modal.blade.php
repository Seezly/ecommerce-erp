...
<div>
	...
	<div class="w-2xl h-128 -translate-[50%] fixed left-[50%] top-[50%] z-10 transform rounded-xl bg-gray-100 shadow-lg">
		<div class="relative flex items-center justify-center border-b px-4 py-2">
		...
		<div class="h-14/16 overflow-hidden overflow-y-auto">
			{{ $slot }}
		</div>
	</div>
</div>
