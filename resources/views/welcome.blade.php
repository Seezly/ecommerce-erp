@php
    ...
    $items = [
        1 => [
            'image' => 'https://plus.unsplash.com/premium_photo-1686247805255-324dfc4e230a?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            'title' => 'Some product',
            'category' => 'Category',
...
<x-layouts::index :title="__('Inicio')">
    ...
    <x-container type="container" :items="$items"/>
    <x-container type="slider" :items="$items"/>
</x-layouts::index>